package src.game.decoration.trees.birch;
...
final class LargeBirchTree implements DecorationSchematic {
	...
	public var schematic: EitherType<String, SchematicDefinition> = GameInfo.schematicPath + "large_birch_tree.mts";
