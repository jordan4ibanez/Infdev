...
final class VirtualHand extends NodeDefinition {
	public function new() {
		...
		this.wieldImage = "infdev_blank_pixel.png";
	}
}
...
final class Hand extends ToolDefinition {
	public function new() {
		...
		this.toolCapabilities = new ToolCapabilities()
			...
			.addGroupCap(NodeGroupWood, new GroupCapabilities(3.5, 6.0, 0, 0))
			.addGroupCap(NodeGroupTree, new GroupCapabilities(3.5, 6.0, 0, 0))
			.addGroupCap(NodeGroupPlanks, new GroupCapabilities(3.5, 6.0, 0, 0));
	}
}
