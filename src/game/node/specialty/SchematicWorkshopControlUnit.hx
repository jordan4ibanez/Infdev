...
final class SchematicWorkshopControlUnit extends NodeDefinition {
	...
	public static var formspec: Formspec = new Formspec("schematic_workshop_ui")
		...
		.addRootElement("size_display", new FormspecLabel(0, 1, 10, 2, "")
			.setStyle(new FormspecLabelStyle()
				.setTextColor("lightgray")
				.setHorizontalAlign(FormspecHorizontalAlignmentCenter)
				.setVerticalAlign(FormspecVerticalAlignmentTop)))
		.addRootElement("error_message", new FormspecLabel(0, 2, 10, 2, "")
			.setStyle(new FormspecLabelStyle()
				.setTextColor("red")
				.setFontSize(30)
				.setHorizontalAlign(FormspecHorizontalAlignmentCenter)
				.setVerticalAlign(FormspecVerticalAlignmentTop)))
		.addRootElement("rename_field", new FormspecField(0.25, 3, 9.5, 1)
			.setStyle(new FormspecFieldStyle()
				.setHorizontalAlign(FormspecHorizontalAlignmentCenter)))
		.addRootElement("update_name", new FormspecButton(2.5, 4.75, 5, 1, "Update Name")
			.setStyle(new FormspecButtonStyle()
				.setSound("lever")))
		.addRootElement("save_schematic", new FormspecButton(2.5, 6.5, 5, 1, "Save Schematic")
			.setStyle(new FormspecButtonStyle()
				.setSound("lever")))
		.addRootElement("exit_button", new FormspecButtonExit(2.5, 8.25, 5, 1, "Exit")
			.setStyle(new FormspecButtonStyle()
				.setSound("lever")));
